...
export default function Home() {
  return (
    ...
    <LinkButton href="https://github.com/xaaug" title='Github'/>
          <LinkButton href="https://www.linkedin.com/in/xanderwayne/" title='Linkedin' />
        </div>
        </div>
     ...
     <div className='flex flex-col gap-8'>
         ...
         <div>
          ...
          <ul className="list-items text-gray-200 text-base">
            {technologies.map((tech, i) => <li key={i} className='text-sm'>{tech}</li>)}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-items  text-gray-200">
            {tools.map((tool, i) => <li key={i} className='text-sm'>{tool}</li>)}
          </ul>
        </div>
        {/* Work Experience */}
        <div>
          ...
          <div className="flex flex-col  gap-2 mb-4">
            ...
            <p className="text-sm">
              Played a key role in developing and enhancing the web platform for
              an intercity travel company, improving connectivity for travelers
              across cities. Collaborating closely with product and design
              teams, I ensured a seamless, high-performance user experience. By
              implementing modern web technologies, I optimized platform
              performance and enhanced customer interactions, focusing on an
              intuitive and accessible booking-to-travel journey.
            </p>
          </div>
          ...
          <div className="flex flex-col  gap-2">
            ...
            <p className="text-sm">
              Built and maintained dynamic, user-focused web applications for a
              rapidly growing food delivery and grocery platform. Working
              closely with cross-functional teams, I helped create seamless
              online experiences that enhanced user engagement and retention. By
              optimizing web performance, I improved load times and overall
